            ...
            echo "
					<div class='card' style='width:300px'>
						...
						<div class='card-body'>
							...
							<a href='index.php?pag=reservar-form&id_vuelo=".$vuelo['id_vuelo']."&id_trayecto=".$vuelo['id_trayecto']."&id_destino=".$vuelo['id_destino']."&id_vuelo_trayecto=".$vuelo['id_vuelo_trayecto']."&id_origen=".$vuelo['id_origen']."&fecha_ida=". $vuelo['fecha_ida'] ."' class='btn btn-info stretched-link'>Reservar</a>							
					</div>";
        }
        ?>
    </section>
