    ...
    <section class="cont-info">
        ...
        foreach ($vuelos as $vuelo) {
            ...
            echo"       </p>
                                ...
                                <a href='index.php?pag=reservar-form&id_vuelo=".$vuelo['id_vuelo']."&id_trayecto=".$vuelo['id_trayecto']."&id_destino=".$vuelo['id_destino']."&id_vuelo_trayecto=".$vuelo['id_vuelo_trayecto']."&id_origen=".$vuelo['id_origen']."' class='btn-reservar btn btn-info'>Reservar</a>
                            </div>                            
                        </article>";
            break;
        }
