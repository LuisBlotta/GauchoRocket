...
function getVuelos(){
    ...
    $sql = "SELECT vuelo_trayecto.id_vuelo_trayecto id_vuelo_trayecto, nivel_modelo.fk_nivel nivel_pasajero, trayecto.precio precio, vuelo_trayecto.fk_vuelo id_vuelo,  vuelo_trayecto.fk_trayecto id_trayecto, vuelo.dia_partida fecha_ida, vuelo.hora_partida hora_partida, d1.descripcion origen , d1.id_destino id_origen,  d0.descripcion destino, d0.id_destino id_destino,tipo_viaje.descripcion tipo_viaje, tipo_vuelo.descripcion tipo_vuelo 
            ...
            JOIN nivel_modelo on nivel_modelo.fk_modelo = modelo.id_modelo
    ...
    if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
            ...
            $vuelo['hora_partida'] =  $row["hora_partida"];
