...
function getVuelos(){
    ...
    $sql = "SELECT vuelo_trayecto.id_vuelo_trayecto id_vuelo_trayecto, nivel_pasajero.id_numero nivel_pasajero, trayecto.precio precio, vuelo_trayecto.fk_vuelo id_vuelo,  vuelo_trayecto.fk_trayecto id_trayecto, vuelo.dia_partida fecha_ida, d1.descripcion origen, d0.descripcion destino, d0.id_destino id_destino,tipo_viaje.descripcion tipo_viaje, tipo_vuelo.descripcion tipo_vuelo 
